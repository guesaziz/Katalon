...
public class KeywordsBase_data {
	...
	Ajouter_Min_Produit(String product){
		...
		def products_min = "//button[contains(@onclick, ${prices_products[0].toString()}) and contains(., '${product}')]"
	...
	@Keyword
	def Saisir_les_données_Paiement(String num_CB,String expire_CB) {
		WebUI.click(findTestObject('Object Repository/Page_Cart Items/span_Pay with Card'))

		WebUI.setText(findTestObject('Object Repository/Page_Cart Items/input_Payer 353,00INR_email'), GlobalVariable.email)



		My_sendKeys_by_Key('Object Repository/Page_Cart Items/input_Payer 353,00INR_card_number',num_CB)

		My_sendKeys_by_Key("Object Repository/Page_Cart Items/input_Payer 353,00INR_cc-exp",expire_CB)
		...
		//def xpath_CB_Type="/html/body/div[3]/form/div[2]/div/div[4]/div/div[2]/div/div/div/div/div/div/div[1]/span"
		//def my_xpath="//span[@class='card amex']"
		...
		if (!CodePosatVisible) {
			WebUI.setText(findTestObject('Object Repository/Page_Cart Items/input_Payer 353,00INR_zip'), GlobalVariable.code_postal)
		}
